...
const InstitutionalAnalytics: React.FC = () => {
    ...
    const carreraInscritos = [
        { name: 'Medicina', value: 450, color: '#800020' },
                    ...
                    <div className="flex items-center gap-12">
                        ...
                        <div className="relative w-48 h-48">
                            <svg viewBox="0 0 36 36" className="w-full h-full -rotate-90">
                                ...
                                <circle cx="18" cy="18" r="16" fill="transparent" stroke="#800020" strokeWidth="4" strokeDasharray="40 100"></circle>
                        ...
                        {ingresosMensuales.map((m) => (
                            <div key={m.month} className="flex-1 flex flex-col items-center gap-3 group">
                                <motion.div 
                                    ...
                                    className="w-full bg-[#001738]/5 group-hover:bg-[#800020] transition-colors rounded-t-xl relative"
                                >
                                    <div className="absolute -top-1 left-0 right-0 h-1 bg-[#800020] rounded-full scale-x-0 group-hover:scale-x-100 transition-transform"></div>
                                </motion.div>
