    ...
    return (
        <div className="w-full space-y-8">
            ...
            <section className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    ...
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-2 pl-3">
                        <span className="flex items-center gap-2 text-slate-500 text-sm font-medium">
                            <User size={14} className="text-[#800020]" /> {studentName}
                        </span>
                        <span className="w-1 h-1 rounded-full bg-slate-300" />
                        <span className="flex items-center gap-2 text-slate-500 text-sm">
                            <School size={14} className="text-[#800020]" /> {carrera}
                        </span>
                        <span className="w-1 h-1 rounded-full bg-slate-300" />
                ...
                <div className="flex gap-3">
                    <button
                        ...
                        className="flex items-center gap-2 px-5 py-3 bg-[#800020] text-white rounded-2xl font-bold text-sm shadow-lg shadow-[#800020]/25 hover:bg-[#5a0015] active:scale-95 transition-all"
                    >
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm group hover:bg-[#800020] transition-all duration-300 cursor-default">
                    <div className="flex justify-between items-start mb-4">
                        <div className="p-2 bg-red-50 rounded-xl group-hover:bg-white/15 transition-colors">
                            <Wallet size={20} className="text-[#800020] group-hover:text-white transition-colors" />
                        </div>
                ...
                <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
                    {isLoading ? (
                        <div className="p-20 flex flex-col items-center justify-center gap-4">
                            <RefreshCw className="animate-spin text-[#800020]" size={32} />
                                ...
                                {payments.map((p) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-5">
                                            <p className="text-sm font-black text-[#800020]">{p.concepto}</p>
                                        ...
                                        <td className="pl-4 pr-8 py-5 text-right">
                                            <button className="text-[#800020] p-2 rounded-xl hover:bg-red-50 transition-colors">
                                                <Eye size={18} />
                                            </button>
                                        </td>
                                    </motion.tr>
                    ...
                    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                        ...
                        >
                            <div className="p-8 text-center">
                                <div className="w-16 h-16 bg-red-50 rounded-3xl flex items-center justify-center mx-auto mb-6 text-[#800020]">
                                    <Upload size={32} />
                                </div>
                                ...
                                <button
                                    ...
                                    className="w-full p-4 bg-[#800020] text-white rounded-2xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-[#5a0015] transition-colors"
                                >
