    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                <div>
                    <h1 className="text-3xl font-black text-[#002f6c] tracking-tight mb-2">Configuración de Personal</h1>
                    <p className="text-slate-500 text-sm font-medium">Asignación manual de roles para cuentas institucionales de la UNAMIS.</p>
                </div>
                <div className="bg-[#002f6c]/5 px-4 py-2 rounded-xl border border-[#002f6c]/10 flex items-center gap-3">
                    <Shield className="text-[#002f6c]" size={20} />
                    <span className="text-[11px] font-black text-[#002f6c] uppercase tracking-widest">Control de Acceso Seguro</span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 h-fit">
                    <div className="flex items-center gap-3 mb-6">
                        <div className="w-10 h-10 bg-[#002f6c] rounded-xl flex items-center justify-center text-white">
                            <Plus size={20} />
                        </div>
                    ...
                    <form onSubmit={handleAddRole} className="space-y-5">
                        <div>
                            ...
                            <input 
                                ...
                                className="w-full bg-slate-50 border border-slate-100 rounded-xl p-3 text-sm focus:bg-white focus:border-[#002f6c] outline-none transition-all"
                            />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select 
                                ...
                                className="w-full bg-slate-50 border border-slate-100 rounded-xl p-3 text-sm focus:bg-white focus:border-[#002f6c] outline-none appearance-none transition-all"
                            >
                                <option value="academico">Coordinador Académico</option>
                                <option value="admin">Finanzas / Administrador</option>
                            </select>
                        </div>
                        <button type="submit" className="w-full py-4 bg-[#002f6c] text-white rounded-xl font-bold text-sm shadow-lg shadow-[#002f6c]/20 hover:bg-[#001738] transition-all">
                                        ...
                                        <tr key={r.id} className="hover:bg-slate-50 transition-colors group">
                                            <td className="px-8 py-5">
                                                <div className="flex items-center gap-4">
                                                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${r.rol === 'admin' ? 'bg-[#002f6c] text-white' : 'bg-blue-600 text-white'}`}>
                                                        <Mail size={18} />
                                                    </div>
                                                    <div>
                                            ...
                                            <td className="px-8 py-5 text-center">
                                                <span className={`text-[9px] font-black uppercase tracking-[0.15em] px-3 py-1.5 rounded-full ${r.rol === 'admin' ? 'bg-red-50 text-[#002f6c] border border-red-100' : 'bg-blue-50 text-blue-600 border border-blue-100'}`}>
